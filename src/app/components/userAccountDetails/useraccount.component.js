...
var UserAccountComponent = (function () {
    function UserAccountComponent(apiService) {
        this.apiService = apiService;
        this.urlExtension = '/api/UserAccount/authorize';
    }
    ...
    UserAccountComponent.prototype.getUserRecords = function () {
        var _this = this;
        this.apiService.getRecords(this.urlExtension) // note, removed this.countries = 
            .subscribe(function (data) {
            _this.userAccounts = data;
        });
    };
    UserAccountComponent.prototype.getUserRecord = function () {
        var _this = this;
        this.apiService.getRecords(this.urlExtension) // note, removed this.countries = 
            .subscribe(function (data) {
            _this.userAccounts = data;
